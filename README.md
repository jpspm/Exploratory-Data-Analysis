...
You can read each of the two files using the function in R.
as long as each of those files is in your current working directory (check by calling and see if those files are in the listing).
